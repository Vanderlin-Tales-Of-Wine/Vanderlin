...
/obj/item/weapon/polearm/halberd/bardiche/woodcutter/getonmobprop(tag)
	...
	if(tag)
		switch(tag)
			...
			if("onback")
				return list("shrink" = 0.5,"sx" = -2,"sy" = -3,"nx" = 6,"ny" = -5,"wx" = 8,"wy" = -5,"ex" = 4,"ey" = -5,"nturn" = 0,"sturn" = 0,"wturn" = 0,"eturn" = 0,"nflip" = 0,"sflip" = 0,"wflip" = 0,"eflip" = 0,"northabove" = 0,"southabove" = 1,"eastabove" = 1,"westabove" = 0)
