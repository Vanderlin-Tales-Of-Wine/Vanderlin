...
/datum/component/darkling/proc/check_light_on_move(/mob/living/carbon/darkling)
...
/datum/component/darkling/proc/try_blind_darkling(/mob/living/carbon/darkling)
