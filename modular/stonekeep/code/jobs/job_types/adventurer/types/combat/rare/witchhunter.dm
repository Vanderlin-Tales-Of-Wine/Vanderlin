...
/datum/advclass/combat/sk_witchhunter
	name = "Witch Hunter"
	...
	outfit = /datum/outfit/job/roguetown/adventurer/sk_witchhunter
...
/datum/outfit/job/roguetown/adventurer/sk_witchhunter/pre_equip(mob/living/carbon/human/H)
	..()
