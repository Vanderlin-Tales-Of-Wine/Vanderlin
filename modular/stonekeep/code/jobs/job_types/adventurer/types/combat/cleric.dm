//shield
/datum/advclass/combat/sk_cleric
	name = "Cleric"
	...
	vampcompat = FALSE
	outfit = /datum/outfit/job/roguetown/adventurer/sk_cleric
	category_tags = list(CTAG_ADVENTURER)
	min_pq = -10
	maximum_possible_slots = 4

/datum/outfit/job/roguetown/adventurer/sk_cleric
	allowed_patrons = ALL_CLERIC_PATRONS

/datum/outfit/job/roguetown/adventurer/sk_cleric/pre_equip(mob/living/carbon/human/H)
	..()
	H.virginity = TRUE
