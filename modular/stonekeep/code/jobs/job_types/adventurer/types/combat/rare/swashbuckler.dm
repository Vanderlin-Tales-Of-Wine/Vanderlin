...
/datum/advclass/combat/sk_swashbuckler
	name = "Swashbuckler"
	...
	outfit = /datum/outfit/job/roguetown/adventurer/sk_swashbuckler
	maximum_possible_slots = 1
	min_pq = 0
	pickprob = 30
	category_tags = list(CTAG_ADVENTURER)

/datum/outfit/job/roguetown/adventurer/sk_swashbuckler
...
/datum/outfit/job/roguetown/adventurer/sk_swashbuckler/pre_equip(mob/living/carbon/human/H)
	..()
	if(H.mind)
