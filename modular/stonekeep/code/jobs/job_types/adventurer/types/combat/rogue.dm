/datum/advclass/combat/sk_rogue
	name = "Rogue"
	...
	outfit = /datum/outfit/job/roguetown/adventurer/sk_rogue
	min_pq = -10
	category_tags = list(CTAG_ADVENTURER)
	cmode_music = 'sound/music/cmode/adventurer/CombatRogue.ogg'

/datum/outfit/job/roguetown/adventurer/sk_rogue/pre_equip(mob/living/carbon/human/H)
	..()
	if(H.mind)
