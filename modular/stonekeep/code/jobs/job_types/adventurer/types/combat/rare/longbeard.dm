...
/datum/advclass/combat/sk/longbeard
	name = "Longbeard"
	...
	outfit = /datum/outfit/job/sk/adventurer/longbeard
...
/datum/outfit/job/sk/adventurer/longbeard/pre_equip(mob/living/carbon/human/H)
	..()
	if(H.mind)
