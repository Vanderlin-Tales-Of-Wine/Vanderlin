/datum/advclass/pilgrim/sk_weaver
	name = "Weaver"
	...
	outfit = /datum/outfit/job/roguetown/adventurer/sk_weaver
	category_tags = list(CTAG_DISABLED)
	apprentice_name = "Weaver"

/datum/outfit/job/roguetown/adventurer/sk_weaver/pre_equip(mob/living/carbon/human/H)
	..()
