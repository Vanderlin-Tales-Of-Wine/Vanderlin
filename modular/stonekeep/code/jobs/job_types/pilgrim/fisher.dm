/datum/advclass/pilgrim/stonekeep/fisher
	name = "Fisher"
	...
	outfit = /datum/outfit/job/sk/pilgrim/fisher
	category_tags = list(CTAG_PILGRIM)
	apprentice_name = "Fisher Apprentice"

/datum/outfit/job/sk/pilgrim/fisher/pre_equip(mob/living/carbon/human/H)
	..()
	if(H.mind)
