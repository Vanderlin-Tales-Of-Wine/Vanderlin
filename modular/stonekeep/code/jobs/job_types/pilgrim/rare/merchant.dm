/datum/advclass/pilgrim/rare/stonekeep/merchant
	...
	allowed_races =list("Humen", "Half-Elf", "Dark Elf", "Elf", "Dwarf","Tiefling", "Aasimar", "Changeling","Skylancer", "Rakshari")


	outfit = /datum/outfit/job/sk/pilgrim/merchant
...
/datum/outfit/job/sk/pilgrim/merchant/pre_equip(mob/living/carbon/human/H)
	..()
