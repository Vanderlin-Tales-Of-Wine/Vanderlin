...
/datum/outfit/job/roguetown/tailor/pre_equip(mob/living/carbon/human/H)
	...
	backpack_contents = list(/obj/item/needle = 1, /obj/item/bundle/cloth = 2, /obj/item/bundle/fibers = 1, /obj/item/dye_pack/luxury = 1, /obj/item/book/rogue/advice_weaving = 1, /obj/item/rogueweapon/knife/villager = 1)
