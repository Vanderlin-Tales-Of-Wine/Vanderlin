/datum/job/roguetown/bard
	title = "Bard"
	tutorial = "Bards make up one of the largest populations of registered adventurers in Enigma, \
...
/datum/job/roguetown/bard/after_spawn(mob/living/carbon/spawned, client/player_client)
	. = ..()
