...
/mob/living/carbon/human/proc/coronate_lord()
	...
	say("By the authority of the Gods, I pronounce you Ruler of all the land!")
	priority_announce("[real_name] the [mind.assigned_role.get_informed_title(src)] has named [coronated.real_name] the inheritor of the realm!", \
