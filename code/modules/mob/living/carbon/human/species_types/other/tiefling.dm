...
/datum/species/tieberian
	...
	specstats = list(STATKEY_STR = 0, STATKEY_PER = 2, STATKEY_INT = 1, STATKEY_CON = -2, STATKEY_END = 0, STATKEY_SPD = 1, STATKEY_LCK = -3)
	specstats_f = list(STATKEY_STR = 0, STATKEY_PER = 2, STATKEY_INT = 1, STATKEY_CON = -2, STATKEY_END = 0, STATKEY_SPD = 1, STATKEY_LCK = -3)
