...
/datum/species/tieberian
	...
	inherent_traits = list(TRAIT_UGLY)
	use_skintones = 1
	disliked_food = NONE
	liked_food = NONE
	...
	specstats = list(STATKEY_STR = 0, STATKEY_PER = 2, STATKEY_INT = 2, STATKEY_CON = -1, STATKEY_END = -1, STATKEY_SPD = 1, STATKEY_LCK = 0)
	specstats_f = list(STATKEY_STR = 0, STATKEY_PER = 2, STATKEY_INT = 2, STATKEY_CON = -1, STATKEY_END = -1, STATKEY_SPD = 1, STATKEY_LCK = 0)
