...
/datum/cameranet/proc/removeCamera(obj/structure/fake_machine/camera/c)
...
/datum/cameranet/proc/updatePortableCamera(obj/structure/fake_machine/camera/c)
	if(c.can_use())
		majorChunkChange(c, 1)
