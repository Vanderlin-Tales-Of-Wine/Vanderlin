...
//	if(mind?.current && (world.time < mind.current.time_of_death_world_time + RESPAWNTIME))
//		to_chat(usr, "<span class='warning'>I can return in [mind.current.time_of_death_world_time + RESPAWNTIME - world.time].</span>")
//		return
