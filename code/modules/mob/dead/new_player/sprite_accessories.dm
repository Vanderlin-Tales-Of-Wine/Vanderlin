...
/datum/sprite_accessory/hair/bald
	name = "Bald"
	icon_state = ""
	specuse = list(SPECIES_HUMAN, "dwarf", "elf", "aasimar", "tiefling", "halforc")
	gender = MALE
...
/datum/sprite_accessory/hair/scribe
	...
	icon_state = "scribe"
	gender = MALE
	specuse = list(SPECIES_HUMAN, "dwarf", "aasimar", "tiefling", "halforc")
	under_layer = TRUE
...
/datum/sprite_accessory/hair/lady
	...
	gender = FEMALE
	specuse = list(SPECIES_HUMAN, "elf", "tiefling")
...
/datum/sprite_accessory/hair/shrine
	...
	icon_state = "shrine_f"
	gender = FEMALE
	specuse = list("elf", "tiefling", SPECIES_HUMAN)
...
/datum/sprite_accessory/facial_hair/brew
	...
	gender = MALE
	specuse = list(SPECIES_HUMAN, "dwarf", "elf", "tiefling", "halforc")
...
/datum/sprite_accessory/accessories
	...
	use_static = TRUE
	specuse = list(SPECIES_HUMAN, "dwarf", "elf")
