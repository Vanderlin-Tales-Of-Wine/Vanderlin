...
/datum/sprite_accessory
	...
	var/list/specuse = list(SPECIES_HUMAN) //what species can use dis
...
/datum/sprite_accessory/hair/bald
	name = "Bald"
	icon_state = ""
	specuse = list(SPECIES_HUMAN, SPECIES_DWARF, SPECIES_ELF, SPECIES_AASIMAR, "tiefling", "halforc")
	gender = MALE
...
/datum/sprite_accessory/hair/scribe
	...
	icon_state = "scribe"
	gender = MALE
	specuse = list(SPECIES_HUMAN, SPECIES_DWARF, SPECIES_AASIMAR, "tiefling", "halforc")
	under_layer = TRUE
...
/datum/sprite_accessory/facial_hair/brew
	...
	gender = MALE
	specuse = list(SPECIES_HUMAN, SPECIES_DWARF, SPECIES_ELF, "tiefling", "halforc")
...
/datum/sprite_accessory/accessories
	...
	use_static = TRUE
	specuse = list(SPECIES_HUMAN, SPECIES_DWARF, SPECIES_ELF)
...
/datum/sprite_accessory/underwear/regm
	...
	icon_state = "male_reg"
	gender = MALE
	specuse = list(SPECIES_HUMAN, SPECIES_AASIMAR, "tiefling", "halforc")
