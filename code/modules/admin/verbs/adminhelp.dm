...
/datum/admin_help/proc/mentorissue(key_name = key_name_admin(usr))
	...
	msg += "<font color='red'>My issue has been determined by an administrator to be related to ingame mechanics, For further resolution please use <a href='byond://winset?command=mentorhelp()'>MENTOR HELP</a>, LOOC, the <a href='byond://winset?command=wiki()'>WIKI</a>, or vanderlin questions on Discord if nobody is responding to a meditation..</font>"
...
/client/proc/get_adminhelp()
	var/msg = input(src, "Please describe my problem concisely and an admin will help as soon as they're able.", "Adminhelp contents") as text|null
	adminhelp(msg)
