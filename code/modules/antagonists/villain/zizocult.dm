...
/datum/antagonist/zizocultist/on_gain()
	...
	if(islesser)
		...
		owner.current.set_skillrank(/datum/skill/combat/knives, 4, TRUE)
		owner.current.set_skillrank(/datum/skill/combat/swords, 4, TRUE)
		owner.current.set_skillrank(/datum/skill/combat/wrestling, 5, TRUE)
		owner.current.set_skillrank(/datum/skill/misc/athletics, 4, TRUE)
		H.change_stat(STATKEY_STR, 2)
