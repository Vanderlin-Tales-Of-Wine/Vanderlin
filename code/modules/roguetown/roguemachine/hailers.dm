...
/obj/structure/roguemachine/hailer
	name = "HAILER"
	desc = ""
...
/obj/structure/roguemachine/hailer/Initialize(mapload)
	. = ..()
	SSroguemachine.hailer = src

/obj/structure/roguemachine/hailer/attackby(obj/item/H, mob/user, params)
...
/obj/structure/roguemachine/hailer/interact(mob/user)
	ui_interact(user)

/obj/structure/roguemachine/hailer/ui_interact(mob/user)
	. = ..()
	var/auth = TRUE
	var/dat = "<B>[name]</B><BR>"
...
/obj/structure/roguemachine/hailer/Topic(href, href_list)
	..()
	usr.set_machine(src)
	if(href_list["remove"])
...
/obj/structure/roguemachine/hailerboard
	name = "HAILER BOARD"
	desc = ""
	icon = 'icons/roguetown/misc/machines.dmi'
	icon_state = "mail"
...
/obj/structure/roguemachine/hailerboard/attack_hand(mob/user)
	. = ..()
	ui_interact(user)

/obj/structure/roguemachine/hailerboard/ui_interact(mob/user)
	. = ..()
	var/dat = "<B>[name]</B><BR>"
...
/obj/structure/roguemachine/hailerboard/Topic(href, href_list)
	..()
	if(href_list["read"])
