...
/obj/structure/roguemachine/submission/proc/attemptsell(obj/item/I, mob/H, message = TRUE, sound = TRUE)
...
/obj/structure/roguemachine/submission/attack_right(mob/user)
	if(ishuman(user))
