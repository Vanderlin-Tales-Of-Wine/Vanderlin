...
/obj/structure/roguemachine/mail/attackby(obj/item/P, mob/user, params)
	if(istype(P, /obj/item/merctoken))
		...
		switch(H.merctype)
			if(0)
				new /obj/item/clothing/neck/roguetown/shalal(drop_location)
			if(1)
				new /obj/item/clothing/neck/roguetown/mercmedal/zybatine(drop_location)
			if(2)
				new /obj/item/clothing/neck/roguetown/mercmedal/grenzelhoft(drop_location)
			if(3)
				new /obj/item/clothing/neck/roguetown/mercmedal/underdweller(drop_location)
			if(4)
				new /obj/item/clothing/neck/roguetown/mercmedal/blackoak(drop_location)
			if(5)
				new /obj/item/clothing/neck/roguetown/mercmedal/steppesman(drop_location)
			if(6)
				new /obj/item/clothing/neck/roguetown/mercmedal/boltslinger(drop_location)
			if(7)
				new /obj/item/clothing/neck/roguetown/mercmedal/anthrax(drop_location)
