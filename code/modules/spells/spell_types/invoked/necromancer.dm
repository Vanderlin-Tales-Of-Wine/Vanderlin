...
/obj/effect/proc_holder/spell/invoked/raise_undead
	name = "Raise Undead"
	desc = "Reanimate a corpse as a skeleton."
	range = 7
	overlay_state = "raiseskele"
...
/obj/effect/proc_holder/spell/invoked/raise_undead_lesser/cast(list/targets, mob/living/carbon/human/user)
	...
	if(user.mind.undeadcurrent < user.mind.undeadmax)
...
/mob/living/carbon/human/proc/turn_to_minion(mob/living/carbon/human/master, ckey)
	...
	mind.clamped_adjust_skillrank(/datum/skill/combat/axesmaces, 3, TRUE)
	...
	mind.clamped_adjust_skillrank(/datum/skill/craft/carpentry, 1, TRUE)
	mind.clamped_adjust_skillrank(/datum/skill/craft/masonry, 1, TRUE)
	mind.clamped_adjust_skillrank(/datum/skill/combat/swords, 3, TRUE)
	mind.clamped_adjust_skillrank(/datum/skill/combat/polearms, 3, TRUE)
	mind.clamped_adjust_skillrank(/datum/skill/labor/mining, 1, TRUE)
	mind.clamped_adjust_skillrank(/datum/skill/labor/lumberjacking, 1, TRUE)
	mind.clamped_adjust_skillrank(/datum/skill/craft/cooking, 1, TRUE)
	mind.clamped_adjust_skillrank(/datum/skill/labor/farming, 1, TRUE)
...
/obj/effect/proc_holder/spell/invoked/revoke_unlife/cast(list/targets, mob/living/carbon/human/user)
	...
	if(!obj || !istype(obj, /mob/living/carbon/human))
		to_chat(user, span_warning("I should cast this spell on my minion to be released."))
		return
	var/mob/living/carbon/human/target = obj

	if(target.stat == DEAD)
		to_chat(user, span_warning("This one is already dead."))
		return
