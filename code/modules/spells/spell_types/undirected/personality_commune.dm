...
/datum/action/cooldown/spell/undirected/personality_commune
...
/datum/action/cooldown/spell/undirected/personality_commune/New(Target)
	. = ..()
...
/datum/action/cooldown/spell/undirected/personality_commune/before_cast(atom/cast_on)
	...
	to_send = browser_input_text(cast_on, "What would you like to tell your other self?", "Commune")
...
/datum/action/cooldown/spell/undirected/personality_commune/cast(mob/living/cast_on)
	. = ..()
	var/datum/brain_trauma/severe/split_personality/trauma = target
