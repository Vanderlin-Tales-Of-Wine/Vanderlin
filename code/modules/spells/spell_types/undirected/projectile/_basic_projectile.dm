 ...
 */
/datum/action/cooldown/spell/undirected/basic_projectile
...
/datum/action/cooldown/spell/undirected/basic_projectile/proc/fire_projectile(atom/target, atom/caster)
