 ...
 */
/datum/action/cooldown/spell/undirected/cone
...
/datum/action/cooldown/spell/undirected/cone/cast(atom/cast_on)
	. = ..()
...
/datum/action/cooldown/spell/undirected/cone/proc/make_cone(list/cone_turfs, atom/caster)
...
/datum/action/cooldown/spell/undirected/cone/proc/do_cone_effects(list/target_turf_list, atom/caster, level = 1)
...
/datum/action/cooldown/spell/undirected/cone/proc/do_turf_cone_effect(turf/target_turf, atom/caster, level)
	return

///This proc deterimines how the spell will affect objects.
/datum/action/cooldown/spell/undirected/cone/proc/do_obj_cone_effect(obj/target_obj, atom/caster, level)
	return

///This proc deterimines how the spell will affect mobs.
/datum/action/cooldown/spell/undirected/cone/proc/do_mob_cone_effect(mob/living/target_mob, atom/caster, level)
	return

///This proc creates a list of turfs that are hit by the cone.
/datum/action/cooldown/spell/undirected/cone/proc/get_cone_turfs(turf/starter_turf, dir_to_use, cone_levels = 3)
...
/datum/action/cooldown/spell/undirected/cone/proc/calculate_cone_shape(current_level)
 ...
 * cone area at once.
 */
/datum/action/cooldown/spell/undirected/cone/staggered

	/// The delay between each cone level triggering.
	var/delay_between_level = 0.2 SECONDS

/datum/action/cooldown/spell/undirected/cone/staggered/make_cone(list/cone_turfs, atom/caster)
	var/level_counter = 0
	for(var/list/turf_list in cone_turfs)
		level_counter++
