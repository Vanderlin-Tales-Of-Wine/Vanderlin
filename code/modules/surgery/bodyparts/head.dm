...
/obj/item/bodypart/head/grabbedintents(mob/living/user, precise)
	...
	switch(used_limb)
		...
		if(BODY_ZONE_PRECISE_SKULL)
			return list(/datum/intent/grabbing/move, /datum/intent/grabbing/smash)
		...
		if(BODY_ZONE_PRECISE_NECK)
			return list(/datum/intent/grabbing/move, /datum/intent/grabbing/choke, /datum/intent/grabbing/hostage)
