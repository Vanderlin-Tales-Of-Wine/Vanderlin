/datum/unit_test/amputation/Run()
	var/mob/living/carbon/humanoid/patient = allocate(/mob/living/carbon/humanoid)
	var/mob/living/carbon/humanoid/user = allocate(/mob/living/carbon/humanoid)
...
/datum/unit_test/head_transplant/Run()
	var/mob/living/carbon/humanoid/user = allocate(/mob/living/carbon/humanoid)
	var/mob/living/carbon/humanoid/alice = allocate(/mob/living/carbon/humanoid)
	var/mob/living/carbon/humanoid/bob = allocate(/mob/living/carbon/humanoid)
...
/datum/unit_test/tend_wounds/Run()
	...
	var/mob/living/carbon/humanoid/naked_patient = allocate(/mob/living/carbon/humanoid)
	naked_patient.get_bodypart(BODY_ZONE_CHEST).receive_damage(100, 100)

	var/mob/living/carbon/humanoid/clothed_patient = allocate(/mob/living/carbon/humanoid)
