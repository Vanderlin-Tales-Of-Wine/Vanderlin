...
/* UNTIL WE GET THE SPRITES FOR IT
/obj/item/clothing/neck/mercmedal/duelist
	name = "valorian blade pendant"
	desc = "A silver pendant shaped as a rapier, Worn by Valorian Duelists to honor their mastery of the blade and unyielding pursuit of glory in combat."
	icon_state = "bladependant"
*/
