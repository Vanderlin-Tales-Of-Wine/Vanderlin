...
/obj/item/clothing/cloak/keffiyeh
	name = "keffiyeh"
	...
	dropshrink = 0.8
	slot_flags = ITEM_SLOT_NECK|ITEM_SLOT_HEAD|ITEM_SLOT_CLOAK|ITEM_SLOT_MASK
...
/obj/item/clothing/cloak/keffiyeh/AdjustClothes(mob/user)
 if(loc == user)
...
/obj/item/clothing/cloak/keffiyeh/red
	color = CLOTHING_BLOOD_RED

/obj/item/clothing/cloak/keffiyeh/yellow
	color = CLOTHING_PEAR_YELLOW

/obj/item/clothing/cloak/keffiyeh/orange
	color = CLOTHING_FYRITIUS_ORANGE

/obj/item/clothing/cloak/keffiyeh/green
	color = CLOTHING_BOG_GREEN

/obj/item/clothing/cloak/keffiyeh/blue
	color = CLOTHING_MAGE_BLUE

/obj/item/clothing/cloak/keffiyeh/purple
	color = CLOTHING_ROYAL_PURPLE

/obj/item/clothing/cloak/keffiyeh/black
	color = CLOTHING_ROYAL_BLACK

/obj/item/clothing/cloak/keffiyeh/white
