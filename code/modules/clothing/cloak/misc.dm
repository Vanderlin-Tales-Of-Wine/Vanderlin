...
/obj/item/clothing/cloak/tribal
	...
	// allowed_race = list(SPECIES_HUMAN, SPECIES_TIEFLING, SPECIES_ELF, SPECIES_AASIMAR, SPECIES_DWARF)
	sleeved = 'icons/roguetown/clothing/onmob/cloaks.dmi'
	nodismemsleeves = TRUE
	boobed = FALSE
	sellprice = 10
...
//	body_parts_covered = ARMS|CHEST
	...
	allowed_sex = list(MALE, FEMALE)
	allowed_race = list(SPECIES_HUMAN, SPECIES_TIEFLING, SPECIES_ELF, SPECIES_AASIMAR)
...
/obj/item/clothing/cloak/cape/puritan
	...
	allowed_race = list(SPECIES_HUMAN, SPECIES_TIEFLING, SPECIES_ELF, SPECIES_DWARF, SPECIES_AASIMAR)
