...
/datum/round_event/ravox_resolve/start()
	...
	to_chat(weakest, span_boldgreen("You are weak compared to your fellow warriors of justice, but still you persevere. The War God honors those who fight even when victory seems impossible. Let his gift be your whetstone — now strike!"))
