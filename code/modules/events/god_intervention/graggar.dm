...
/datum/culling_duel/proc/process_win(mob/living/winner, mob/living/loser)
	...
	winner.add_stress(/datum/stressevent/graggar_culling_finished)
	winner.playsound_local(winner, 'sound/ambience/noises/genspooky (1).ogg')
...
/datum/round_event/graggar_culling/start()
	...
	for(var/i in 1 to max_pairs)
		...
		first_chosen.playsound_local(first_chosen, 'sound/magic/marked.ogg')
		...
		second_chosen.playsound_local(second_chosen, 'sound/magic/marked.ogg')
