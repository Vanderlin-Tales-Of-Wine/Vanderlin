...
#define debug_world(msg) if (GLOB.Debug) to_chat(world, "DEBUG: [msg]")
#define debug_usr(msg) if (GLOB.Debug&&usr) to_chat(usr, "DEBUG: [msg]")
#define debug_admins(msg) if (GLOB.Debug) to_chat(GLOB.admins, "DEBUG: [msg]")
#define debug_world_log(msg) if (GLOB.Debug) log_world("DEBUG: [msg]")
