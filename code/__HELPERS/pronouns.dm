...
/mob/living/carbon/humanoid/p_they(capitalized, temp_gender)
...
/mob/living/carbon/humanoid/p_their(capitalized, temp_gender)
	var/list/obscured = check_obscured_slots()
	var/skipface = (wear_mask && (wear_mask.flags_inv & HIDEFACE)) || (head && (head.flags_inv & HIDEFACE))
	if((SLOT_PANTS in obscured) && skipface)
		temp_gender = PLURAL
...
/mob/living/carbon/humanoid/p_them(capitalized, temp_gender)
	var/list/obscured = check_obscured_slots()
	var/skipface = (wear_mask && (wear_mask.flags_inv & HIDEFACE)) || (head && (head.flags_inv & HIDEFACE))
	if((SLOT_PANTS in obscured) && skipface)
		temp_gender = PLURAL
...
/mob/living/carbon/humanoid/p_have(temp_gender)
	var/list/obscured = check_obscured_slots()
	var/skipface = (wear_mask && (wear_mask.flags_inv & HIDEFACE)) || (head && (head.flags_inv & HIDEFACE))
	if((SLOT_PANTS in obscured) && skipface)
		temp_gender = PLURAL
...
/mob/living/carbon/humanoid/p_are(temp_gender)
	var/list/obscured = check_obscured_slots()
	var/skipface = (wear_mask && (wear_mask.flags_inv & HIDEFACE)) || (head && (head.flags_inv & HIDEFACE))
	if((SLOT_PANTS in obscured) && skipface)
		temp_gender = PLURAL
...
/mob/living/carbon/humanoid/p_were(temp_gender)
	var/list/obscured = check_obscured_slots()
	var/skipface = (wear_mask && (wear_mask.flags_inv & HIDEFACE)) || (head && (head.flags_inv & HIDEFACE))
	if((SLOT_PANTS in obscured) && skipface)
		temp_gender = PLURAL
...
/mob/living/carbon/humanoid/p_do(temp_gender)
	var/list/obscured = check_obscured_slots()
	var/skipface = (wear_mask && (wear_mask.flags_inv & HIDEFACE)) || (head && (head.flags_inv & HIDEFACE))
	if((SLOT_PANTS in obscured) && skipface)
		temp_gender = PLURAL
...
/mob/living/carbon/humanoid/p_s(temp_gender)
	var/list/obscured = check_obscured_slots()
	var/skipface = (wear_mask && (wear_mask.flags_inv & HIDEFACE)) || (head && (head.flags_inv & HIDEFACE))
	if((SLOT_PANTS in obscured) && skipface)
		temp_gender = PLURAL
...
/mob/living/carbon/humanoid/p_es(temp_gender)
	var/list/obscured = check_obscured_slots()
	var/skipface = (wear_mask && (wear_mask.flags_inv & HIDEFACE)) || (head && (head.flags_inv & HIDEFACE))
	if((SLOT_PANTS in obscured) && skipface)
		temp_gender = PLURAL
