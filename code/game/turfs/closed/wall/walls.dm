/turf/closed/wall/mineral/stone
	...
	smoothing_groups = SMOOTH_GROUP_WALLS + SMOOTH_GROUP_CLOSED_WALL + SMOOTH_GROUP_WALLS_STONE
	smoothing_list = SMOOTH_GROUP_WALLS + SMOOTH_GROUP_WALLS_STONE
...
/turf/closed/wall/mineral/decorstone
	...
	smoothing_groups = SMOOTH_GROUP_WALLS + SMOOTH_GROUP_CLOSED_WALL + SMOOTH_GROUP_WALLS_STONE_DECO
	smoothing_list = SMOOTH_GROUP_WALLS + SMOOTH_GROUP_WALLS_STONE_DECO
	above_floor = /turf/open/floor/blocks
	baseturfs = list(/turf/open/floor/blocks)
	neighborlay = "dirtedge"
	climbdiff = 1
...
/turf/closed/wall/mineral/craftstone
	...
	attacked_sound = list('sound/combat/hits/onstone/wallhit.ogg', 'sound/combat/hits/onstone/wallhit2.ogg', 'sound/combat/hits/onstone/wallhit3.ogg')
	smoothing_flags = SMOOTH_BITMASK
	smoothing_groups = SMOOTH_GROUP_WALLS + SMOOTH_GROUP_CLOSED_WALL + SMOOTH_GROUP_WALLS_STONE_CRAFT
	smoothing_list = SMOOTH_GROUP_WALLS + SMOOTH_GROUP_WALLS_STONE_CRAFT
	above_floor = /turf/open/floor/blocks
	baseturfs = list(/turf/open/floor/blocks)
	neighborlay = "dirtedge"
	climbdiff = 1
...
/turf/closed/wall/mineral/stonebrick
	...
	attacked_sound = list('sound/combat/hits/onstone/wallhit.ogg', 'sound/combat/hits/onstone/wallhit2.ogg', 'sound/combat/hits/onstone/wallhit3.ogg')
	smoothing_flags = SMOOTH_BITMASK
	smoothing_groups = SMOOTH_GROUP_WALLS + SMOOTH_GROUP_CLOSED_WALL + SMOOTH_GROUP_WALLS_STONE_BRICK
	smoothing_list = SMOOTH_GROUP_WALLS + SMOOTH_GROUP_WALLS_STONE_BRICK
	above_floor = /turf/open/floor/blocks
	baseturfs = list(/turf/open/floor/blocks)
	neighborlay = "dirtedge"
	climbdiff = 4
...
/turf/closed/wall/mineral/wood
	...
	smoothing_flags = SMOOTH_BITMASK
	smoothing_groups = SMOOTH_GROUP_WALLS + SMOOTH_GROUP_CLOSED_WALL + SMOOTH_GROUP_WALLS_WOOD
	smoothing_list = SMOOTH_GROUP_WALLS + SMOOTH_GROUP_WALLS_WOOD
	neighborlay = "dirtedge"
...
/turf/closed/wall/mineral/pipe
	...
	smoothing_flags = SMOOTH_BITMASK_CARDINALS
	smoothing_groups = SMOOTH_GROUP_WALLS + SMOOTH_GROUP_CLOSED_WALL + SMOOTH_GROUP_WALLS_PIPE
	smoothing_list = SMOOTH_GROUP_WALLS + SMOOTH_GROUP_WALLS_PIPE
...
/turf/closed/wall/mineral/underbrick
	...
	attacked_sound = list('sound/combat/hits/onstone/wallhit.ogg', 'sound/combat/hits/onstone/wallhit2.ogg', 'sound/combat/hits/onstone/wallhit3.ogg')
	smoothing_flags = SMOOTH_BITMASK_CARDINALS
	smoothing_groups = SMOOTH_GROUP_WALLS + SMOOTH_GROUP_CLOSED_WALL + SMOOTH_GROUP_WALLS_EREBUS
	smoothing_list = SMOOTH_GROUP_WALLS + SMOOTH_GROUP_WALLS_EREBUS
